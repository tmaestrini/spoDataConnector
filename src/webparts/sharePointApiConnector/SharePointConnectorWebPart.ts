...
export interface ISharePointConnectorWebPartWebPartProps {
  description: string;
}

export default class SharePointConnectorWebPartWebPart extends BaseClientSideWebPart<ISharePointConnectorWebPartWebPartProps> {
